  ...
  return (
    <SectionContainer id="contact">
      <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative overflow-hidden rounded-[32px] border border-slate-200/70 bg-white/90 p-10 shadow-xl shadow-slate-200/30 backdrop-blur-xl dark:border-slate-800/70 dark:bg-slate-900/70">
        ...
        <div className="space-y-6">
          <div className="rounded-[32px] border border-slate-200/70 bg-white/80 p-8 shadow-xl shadow-slate-200/30 backdrop-blur-xl dark:border-slate-800/70 dark:bg-slate-900/70">
            <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100">{t.about.name}</h3>
              ...
              {contactCards.map((card) => {
                ...
                return (
                  <a
                    ...
                    className="flex items-center gap-3 rounded-2xl border border-slate-200/60 bg-white/90 px-4 py-3 transition hover:border-accent hover:text-secondary dark:border-slate-700/60 dark:bg-slate-900/60"
                  >
          ...
          <div className="overflow-hidden rounded-[32px] border border-slate-200/70 bg-white/70 shadow-xl shadow-slate-200/30 dark:border-slate-800/70 dark:bg-slate-900/70">
            <img
